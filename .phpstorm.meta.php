...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/adminsena/Escritorio/MI_APP/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/adminsena/Escritorio/MI_APP/public/storage',
...
'web','api',);
        registerArgumentsSet('routes', 'password.request','password.email','password.reset',
'password.store','register','login',
'verification.notice','verification.verify','verification.send','password.confirm',
'logout','profile.edit','profile.update','profile.destroy','dashboard',
'dashboard.abogado','dashboard.asistente','profile.photo','profile.photo.update','lawyers.check-duplicates',
'lawyers.check-field','lawyers.export.pdf','lawyers.export.excel','lawyers.update','lawyers.index',
'lawyers.create','lawyers.store','lawyers.show','lawyers.edit','lawyers.destroy',
'assistants.update','assistants.destroy','asistentes.destroy','asistente.export.pdf','asistente.export.excel',
'procesos.export.pdf','procesos.export.excel','procesos.index','procesos.create','procesos.store',
'procesos.show','procesos.edit','procesos.update','procesos.destroy','procesos.concepto.create',
'procesos.concepto.store','procesos.conceptos.update','procesos.conceptos','mis.procesos','legal_processes.create',
'abogado.misConceptos','abogado.listar-procesos','abogado.finalizar-proceso','abogado.guardar-concepto','abogado.crear-concepto',
'abogado.conceptos.storeProceso','conceptos.create','conceptos.store','conceptos.destroy','concepto.show',
'validar.asistente','procesos.historial','documentos.destroy','pagos.index','pagos.store','pagos.aprobar','pagos.rechazar','notifications.mark-all-read',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.reset-password','auth.verify-email',
...
'components.input-error','components.input-label','components.modal','components.nav-link','components.notification-dropdown',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','dashboard',
'dashboard-abogado','dashboard.abogado','dashboard.admin','emails.send-credentials','exports.asistente-pdf',
'exports.lawyers-pdf','exports.procesos-pdf','layouts.app','layouts.guest','layouts.navigation',
'legal_processes.conceptos','legal_processes.create','legal_processes.createConceptos','legal_processes.editProcesos','legal_processes.index',
'legal_processes.showConceptos','legal_processes.verConcepto','notifications::email','pagos','profile.edit',
'profile.partials.assistants-table','profile.partials.assistants-table-simple','profile.partials.delete-user-form','profile.partials.lawyers-table','profile.partials.lawyers-table-simple',
'profile.partials.pagination','profile.partials.procesos-table-simple','profile.partials.process-card','profile.partials.processes-table','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','profile.photo','vendor.notifications.email','welcome','laravel-exceptions-renderer::components.card',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','validation.password',
'validation.attributes.email','validation.attributes.password',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','APP_LOCALE',
'APP_FALLBACK_LOCALE','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK',
